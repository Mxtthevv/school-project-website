    ...
    <!-- KONIEC GALERII ZDJĘĆ -->
        ...
        <div class="srodek">
          <?php
            ...
            $q1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty";
            $q2 = "SELECT nazwa_produkt, nazwa_nasiona, pochodzenie, cena, zdjecie FROM nasiona";
            $q3 = "SELECT nazwa_produkt, nazwa_doniczki, cena, zdjecie FROM doniczki";
            
            $dbq1 = mysqli_query($server, $q1);
            $dbq2 = mysqli_query($server, $q2);
            $dbq3 = mysqli_query($server, $q3);

            while($r = mysqli_fetch_array($dbq1)) {
            ...
            while($r = mysqli_fetch_array($dbq2)) {
              echo "<section class='blok'>";
            ...
            while($r = mysqli_fetch_array($dbq3)) {
              echo "<section class='blok'>";
            ...
            if(isset($_POST['kwiaty'])) {
              $rodzaj = $_POST['kwiaty'];
              $f1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty WHERE id_kategoria=$rodzaj";
            ...
            if(isset($_POST['cena'])) {
              $c1 = "SELECT * FROM kwiaty, nasiona, doniczki ORDER BY kwiaty.cena, nasiona.cena, doniczki.cena ASC";
