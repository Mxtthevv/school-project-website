    ...
    <!-- KONIEC GALERII ZDJĘĆ -->
        ...
        <div class="srodek">
          <?php
            ...
            if(isset($_POST['najtaniej'])) {
                $c1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty ORDER BY kwiaty.cena ASC";
                $c2 = "SELECT nazwa_produkt, nazwa_nasiona, pochodzenie, cena, zdjecie FROM nasiona ORDER BY nasiona.cena ASC";
                $c3 = "SELECT nazwa_produkt, nazwa_doniczki, cena, zdjecie FROM doniczki ORDER BY doniczki.cena ASC";
                
                $dbc1 = mysqli_query($server, $c1);
                $dbc2 = mysqli_query($server, $c2);
                $dbc3 = mysqli_query($server, $c3);

                while($r = mysqli_fetch_array($dbc1)) {
                ...
                while($r = mysqli_fetch_array($dbc2)) {
                echo "<section class='blok'>";
                ...
                while($r = mysqli_fetch_array($dbc3)) {
                echo "<section class='blok'>";
            ...
            } elseif(isset($_POST['najdrozej'])) {
                $c1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty ORDER BY kwiaty.cena DESC";
                $c2 = "SELECT nazwa_produkt, nazwa_nasiona, pochodzenie, cena, zdjecie FROM nasiona ORDER BY nasiona.cena DESC";
                $c3 = "SELECT nazwa_produkt, nazwa_doniczki, cena, zdjecie FROM doniczki ORDER BY doniczki.cena DESC";
            ...
            } elseif(isset($_POST['odpoczatku'])) {
                $c1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty ORDER BY kwiaty.nazwa_kwiat ASC";
                $c2 = "SELECT nazwa_produkt, nazwa_nasiona, pochodzenie, cena, zdjecie FROM nasiona ORDER BY nasiona.nazwa_nasiona ASC";
                $c3 = "SELECT nazwa_produkt, nazwa_doniczki, cena, zdjecie FROM doniczki ORDER BY doniczki.nazwa_doniczki ASC";
            ...
            } elseif(isset($_POST['odkonca'])) {
                $c1 = "SELECT nazwa_kwiat, nazwa_produkt, zdjecie, pochodzenie, cena FROM kwiaty ORDER BY kwiaty.nazwa_kwiat DESC";
                $c2 = "SELECT nazwa_produkt, nazwa_nasiona, pochodzenie, cena, zdjecie FROM nasiona ORDER BY nasiona.nazwa_nasiona DESC";
                $c3 = "SELECT nazwa_produkt, nazwa_doniczki, cena, zdjecie FROM doniczki ORDER BY doniczki.nazwa_doniczki DESC";
